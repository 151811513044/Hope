                    ...
                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <img src="{{ asset('storage/images/carousel/'.$carousel->photo) }}" height="80px" alt="">
                                </td>
                ...
                <form action="{{ url('/carousel')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class=" form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <small>size image: 1054 x 400 (recommended)</small>
                        </div>
                    </div>
                    <div class="form-group row">
...
<div class="modal fade show" id="edit-{{$carousel->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/carousel')}}/{{ $carousel->id}}" method="post">
                    {{ csrf_field()}}
                    @method('patch')
                    <div class="form-group row">
                        <label class="col-sm-4 col-form-label">Is Default</label>
