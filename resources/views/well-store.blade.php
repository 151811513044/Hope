...
<div class="popular-product-area wrapper-padding-3">
    <div class="container mb-5">
        <div class="section-title-6  text-left">
            ...
            @endif
            @if(Auth::user())
            <a href="{{url('/home/stores')}}/{{$store->id}}">
                <h2><i class="ti-home"></i> {{$store->name}}</h2>
            </a>
            @endif
        </div>
...
<!-- End Carousel Toko -->
<!-- banner area start -->
<div class="banner-area pt-90 fix">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="furits-banner-wrapper mb-30 wow fadeInLeft">
                    <img src="{{asset('themes/ezone/assets/img/banner/40.jpg')}}" alt="New Product">
